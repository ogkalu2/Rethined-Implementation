...
class InpaintingLoss(nn.Module):
    ...
    def _transport_self_patch_loss(
        ...
        if query_mask_flat is None or transport_values is None or transport_validity is None:
            return zero, metrics
    ...
    def _transport_offset_smoothness_loss(
        ...
        if query_mask_flat is None or coords_flat is None or base_coords_flat is None:
            return zero, metrics
